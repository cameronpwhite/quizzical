...
const useSimpleAuth = () => {
    ...
    const isAuthenticated = () => localStorage.getItem("quiz_token") !== null
        || sessionStorage.getItem("quiz_token") !== null
    ...
    const register = (user) => {
        ...
        .then(response => {
            if ("id" in response) {
                ...
                localStorage.setItem("quiz_token", encoded)
            }
        })
    }
    ...
    const getCurrentUser = () => {
        const encoded = localStorage.getItem("quiz_token")
